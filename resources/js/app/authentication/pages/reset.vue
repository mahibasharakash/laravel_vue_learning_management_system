<template>
    ...
    <form class="w-full">
        ...
        <div class="mb-4 w-full block">
            ...
            <input id="reset_code" type="text" name="reset_code" class="form-control" required autocomplete="off" />
        </div>
        <div class="mb-4 w-full block">
        ...
        <div class="text-center text-sm font-medium"> Remember Password <br> <a href="javascript:void(0)" class="underline text-blue-500 duration-500 hover:text-blue-700 text-sm"> Login </a> </div>
    </form>
