<template>
    ...
    <div class="w-full bg-white rounded-md px-6 py-3 flex justify-start items-center gap-3 shadow-lg">
        ...
        <RouterLink :to="{name:'comments'}" class="decoration-0 text-black inline-block font-medium text-md">
            Comments
        </RouterLink>
    </div>
    <!-- / breadcrumb -->
                ...
                <div class="w-full block">
                    ...
                    <div class="mb-3 w-full block">
                        ...
                        <div class="w-full relative">
                            <select name="user_id" id="user_id" class="form-select" autocomplete="off">
                    ...
                    <div class="mb-3 w-full block">
                        ...
                        <div class="w-full relative">
                            <select name="lesson_id" id="lesson_id" class="form-select" autocomplete="off">
                    ...
                    <div class="mb-3 w-full block">
                        ...
                        <textarea name="content" id="content" class="form-textarea" cols="30" rows="4" autocomplete="off"></textarea>
                        <div class="mt-2 w-full block text-red-500 text-xs font-medium" v-if="error?.content"> {{error?.content[0]}} </div>
                    </div>
                    <!-- / content -->
    ...
    data() {
        return {
            ...
            formData: {
                ...
                lesson_id: '', // FOREIGN KEY (lesson_id) REFERENCES lessons(id) ON DELETE CASCADE
                content: '',
                created_at: '',
                updated_at: '',
            },
