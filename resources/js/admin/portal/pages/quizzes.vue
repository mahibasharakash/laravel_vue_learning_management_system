<template>
    ...
    <div class="w-full bg-white rounded-md px-6 py-3 flex justify-start items-center gap-3 shadow-lg">
        ...
        <RouterLink :to="{name:'quizzes'}" class="decoration-0 text-black inline-block font-medium text-md">
            Quizzes
        </RouterLink>
    </div>
    <!-- / breadcrumb -->
    ...
    <div class="w-full mt-3">
        ...
        <!-- no data found -->
        <emptyPage message="No Quizzes Available" subMessage="quiz" @add="openManageModal(null)" v-if="tableData.length === 0 && !listLoading"></emptyPage>
        <!-- / no data found -->
